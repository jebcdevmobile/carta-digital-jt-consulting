      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Sheet open={isMobileOpen} onOpenChange={setIsMobileOpen}>
            ...
            <SheetContent
              side="top"
              className="bg-[#0D2137] border-t border-white/10 pt-6 pb-8"
            >
              ...
              <div className="px-6 space-y-4">
                {NAV_LINKS.map((link) => (
                  <a
                    key={link.i18nKey}
                    href={link.href}
                    className="block text-white hover:text-[#C9A84C] transition-colors text-base font-medium py-2 border-l-2 border-transparent hover:border-[#C9A84C] pl-3"
                    onClick={(e) => {
                      e.preventDefault();
                      handleNavClick(link.href);
                    }}
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#25D366] hover:bg-[#20bd5a] text-white px-5 py-3 rounded-lg font-semibold text-sm transition-colors flex items-center gap-3 w-fit shadow-md"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-5 h-5"
                  ...
                  <span>{t("nav_whatsapp_mobile")}</span>
                </a>
              </div>
            </SheetContent>
          </Sheet>
